...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={`data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-background/80 backdrop-blur-sm ${className || ""}`}
    {...props}
    ref={ref}
  />
));
